...
class Config extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    const ORDER_NOTIFICATION = 'connector/setting/order_notification';
    const DEBUG = 'connector/setting/debug';
    ...
    {
        $value = $this->scopeConfig->getValue(self::ORDER_NOTIFICATION);
        return $value;
    }

    public function getDebugSetting()
    {
        $value = $this->scopeConfig->getValue(self::DEBUG);
        return $value;
    }
    ...
    {
        $value = $this->scopeConfig->getValue(self::SETTING_PATH.'shop_id');
        return $value;
    }
