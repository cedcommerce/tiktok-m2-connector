...
class App extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        if (true) {
            ...
            $resultPage->getConfig()->getTitle()->prepend(__('Magento Connector'));
            return $resultPage;
        }

        $this->messageManager->addErrorMessage('Not Connected Successfully.');
