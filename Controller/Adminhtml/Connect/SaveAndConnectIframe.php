...
class SaveAndConnectIframe extends \Magento\Backend\App\Action
{
    /**
     * @var PageFactory
     */
    ...
    public function execute()
    {
        ...
        try {
            ...
            if (isset($response['token'])) {
                ...
                $this->messageManager->addSuccessMessage('Please wait while we are connecting....');
    ...
    {
        return $this->_authorization->isAllowed('Ced_MagentoConnector::MagentoConnector');
    }
}
